...
public class WorkItemPersistenceEventHandler implements WorkItemPersistenceService {
	...
	public WorkItemPersistenceEventHandler(final WorkItemRepository orderRepository,
	    final WorkItemCommentRepository workItemCommentRepository) {
	...
	public WorkItemUpdatedEvent updateWorkItem(UpdateWorkItemEvent updateWorkItemEvent) {
		...
		workItem = workItemRepository.save(WorkItem.fromWorkItemDetails(updateWorkItemEvent
		    .getWorkItemDetails()));
	...
	public WorkItemUpdatedEvent addCommentToWorkItem(
		...
		workItemComment.setId(null);
		
		workItemCommentRepository.save(workItemComment);
