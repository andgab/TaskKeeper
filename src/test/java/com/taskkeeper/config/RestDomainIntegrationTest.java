...
import com.taskkeeper.config.MVCConfig;
...
import static com.taskkeeper.rest.controller.fixture.RestDataFixture.standardOrderJSON;
...
@WebAppConfiguration
@ContextConfiguration(classes = {StandaloneDataConfig.class, JPAConfiguration.class, PersistenceConfig.class, CoreConfig.class, MVCConfig.class})
